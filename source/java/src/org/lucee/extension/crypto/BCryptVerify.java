 ...
 *
 * Usage:
 *   isValid = BCryptVerify( "password", hash )
 *   isValid = BCryptVerify( "password", hash, true )  // throws on invalid hash format
 *
 * Replaces VerifyBCryptHash() which is retained as a deprecated alias.
 */
public class BCryptVerify extends BIF {
	...
	/**
	 * Core implementation shared by BCryptVerify and VerifyBCryptHash.
	 */
	...
	public Object invoke( PageContext pc, Object[] args ) throws PageException {
		...
		if ( args.length < 2 ) {
			throw eng.getExceptionUtil()
				.createFunctionException( pc, "BCryptVerify", 2, "hash", "Input and hash are required", null );
		}
